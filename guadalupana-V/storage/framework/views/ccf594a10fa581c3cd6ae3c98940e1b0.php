...
<head>
    ...
    <link href="<?php echo e(asset('asset/heladeria.css')); ?>" rel="stylesheet">
</head>
...
<div class="ContainerHeladeria">
    ...
    <div class="Cuadro">
        ...
        <div class="Detalle">
            <div class="Sabores">
                <h3>Sabores:</h3>
                <div class="Sabor" id="sabor1"></div>
                <div class="Sabor" id="sabor2"></div>
                <div class="Sabor" id="sabor3"></div>
                <div class="Sabor" id="sabor4"></div>
            </div>
            <div class="botones">
                <h3>Cantidad</h3>
                <div class="BotonPedir">Pedir</div>
...
<?php /**PATH C:\Users\quice\Desktop\Proyecto_restaurante\guadalupana-V\resources\views//auth/heladeria.blade.php ENDPATH**/ ?>