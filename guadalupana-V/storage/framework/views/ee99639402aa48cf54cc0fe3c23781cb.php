...
<head>
    ...
    <link href="<?php echo e(asset('asset/login.css')); ?>" rel="stylesheet">
</head>
<body>
    ...
    <div class="contenedor__todo">
        <div class="caja__trasera">
            <div class="caja__trasera-login">
                ...
                <a href="<?php echo e(route('login')); ?>"><button id="btn__iniciar-sesion">Iniciar Sesión</button></a>
            </div>
            <div class="caja__trasera-register">
                <h3>¿Aún no tienes una cuenta?</h3>
                <p>Regístrate para que puedas iniciar sesión</p>
                <a href="<?php echo e(route('register')); ?>"><button id="btn__registrarse">Regístrarse</button></a>
            </div>
        </div>

        <div class="contenedor__login-register">
            <form action="<?php echo e(route('login')); ?>" method="POST" class="formulario__login">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <button type="submit" class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"><?php echo e(__('Iniciar sesión')); ?></button>
            </form>
        </div>
    </div>
</main>
...
</html><?php /**PATH C:\Users\quice\Desktop\Proyecto_restaurante\guadalupana-V\resources\views/auth/login.blade.php ENDPATH**/ ?>