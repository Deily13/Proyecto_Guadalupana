...
<form method="POST" action="{{ route('register') }}" class="formulario__register">
        ...
        <div class="mt-4">
            ...
            <!-- Se omite manejo de errores para nombre -->
        </div>
        ...
        <div class="mt-4">
            ...
            <!-- Se omite manejo de errores para apellidos -->
        </div>
        ...
        <div class="mt-4">
            ...
            <!-- Se omite manejo de errores para tipo de identificación -->
        </div>
        ...
        <div class="mt-4">
            ...
            <!-- Se omite manejo de errores para número de identificación -->
        </div>
        ...
        <div class="mt-4">
            ...
            <!-- Se omite manejo de errores para número de celular -->
        </div>
        ...
        <div class="mt-4">
            ...
            <!-- Se omite manejo de errores para dirección -->
        </div>
